...
class PowerSenseModulePublisher(Node):
    def __init__(self):
        ...
        self.voltageMin = self.get_parameter("internal_status.voltage_min").get_parameter_value().double_value

        self.declare_parameter("internal_status.voltage_max", 16.8)
        self.voltageMax = self.get_parameter("internal_status.voltage_max").get_parameter_value().double_value
